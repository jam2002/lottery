...
namespace Lottery.Core.Plan
{
    public abstract class Dynamic
    {
        ...
        {
            return string.Join(".", LotteryName, GameName, GameArgs ?? string.Empty, GroupName ?? string.Empty, EnableSinglePattern ? "S" : "C", RespectRepeat ? "R" : "WR", UseGeneralTrend ? "G" : "WG", ChangeBetPerTime ? "C" : "WC", EnableContinuous ? "E" : "WE", TakeNumber, WaitInterval, BetCycle, TupleLength, SpanLength, Rank, GeneralTrendInterval, NumberLength, StartSpan);
        }
