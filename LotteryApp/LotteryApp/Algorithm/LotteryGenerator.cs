    ...
    public class LotteryGenerator
    {
        public static LotteryMetaConfig GetConfig()
        {
            ...
            else
            {
                ...
                {
                new Lottery {  Key = "cqssc", DisplayName="重庆时时彩", RegexPattern = @"(?<=\d{11}\s)(\d\s){4}\d", StartIndex = 0, Length =5, MaxBetCount =200,  HasPair = true, HasDynamic = true, TradingHours = new string[] { "00:00:00-02:00:00", "09:50:00-23:59:59" } },
                ...
                new Lottery {  Key = "tjssc", DisplayName="天津时时彩", RegexPattern = @"(?<=\d{10}\s)(\d\s){4}\d", StartIndex = 0, Length =5, MaxBetCount =200,  HasPair = true, HasDynamic = true, TradingHours = new string[] { "09:00:00-23:00:00" } },
